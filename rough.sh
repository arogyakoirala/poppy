...
nohup ./predict.sh process=solo shp=/data/tmp/arogya/inputs/aoi.gpkg model=/data/tmp/arogya/results/aoi_2019/models/model-kmeans-3 mask=/data/tmp/arogya/inputs/mask.tif cores=5 year=2019 out=../data/2019_roa/predictions interim=../data/2019_roa/interim > logs/2019_roa.out &
